...
- This is not a pattern known by a formal name
- This basically involves creating a helper function for a context that is
  responsible for calling dispatch as needed to ensure it is called correctly
- Consumers are responsible for passing dispatch into this helper function, but
  do not need to worry about calling dispatch directly
